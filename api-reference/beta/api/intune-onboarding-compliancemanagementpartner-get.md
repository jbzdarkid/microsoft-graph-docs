...
<!-- { "blockType": "permissions", "name": "intune_onboarding_compliancemanagementpartner_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-compliancemanagementpartner-get-permissions.md)]
