...
<!-- { "blockType": "permissions", "name": "intune_devices_manageddevice_createdevicelogcollectionrequest" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-manageddevice-createdevicelogcollectionrequest-permissions.md)]
