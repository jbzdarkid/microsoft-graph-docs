...
<!-- { "blockType": "permissions", "name": "synchronization_synchronizationjob_post" } -->
[!INCLUDE [permissions-table](../includes/permissions/synchronization-synchronizationjob-post-permissions.md)]
