...
<!-- { "blockType": "permissions", "name": "synchronization_synchronizationjob_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/synchronization-synchronizationjob-list-permissions.md)]
