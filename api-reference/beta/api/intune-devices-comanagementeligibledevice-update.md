...
<!-- { "blockType": "permissions", "name": "intune_devices_comanagementeligibledevice_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-comanagementeligibledevice-update-permissions.md)]
