...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidvpnconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidvpnconfiguration-create-permissions.md)]
...
## Response
If successful, this method returns a `201 Created` response code and a [androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md) object in the response body.
