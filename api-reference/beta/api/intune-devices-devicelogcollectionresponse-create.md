...
<!-- { "blockType": "permissions", "name": "intune_devices_devicelogcollectionresponse_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicelogcollectionresponse-create-permissions.md)]
