...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecompliancesettingstate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecompliancesettingstate-update-permissions.md)]
