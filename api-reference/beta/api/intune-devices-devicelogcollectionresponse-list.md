...
<!-- { "blockType": "permissions", "name": "intune_devices_devicelogcollectionresponse_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicelogcollectionresponse-list-permissions.md)]
