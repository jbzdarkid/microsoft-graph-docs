...
<!-- { "blockType": "permissions", "name": "intune_devices_devicehealthscriptdevicestate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicehealthscriptdevicestate-update-permissions.md)]
