...
<!-- { "blockType": "permissions", "name": "intune_apps_enterprisecodesigningcertificate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-enterprisecodesigningcertificate-update-permissions.md)]
