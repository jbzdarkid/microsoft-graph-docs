...
<!-- { "blockType": "permissions", "name": "intune_devices_devicehealthscriptpolicystate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicehealthscriptpolicystate-update-permissions.md)]
