...
<!-- { "blockType": "permissions", "name": "intune_apps_managedandroidlobapp_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-managedandroidlobapp-update-permissions.md)]
