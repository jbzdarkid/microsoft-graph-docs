...
<!-- { "blockType": "permissions", "name": "intune_onboarding_compliancemanagementpartner_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-compliancemanagementpartner-update-permissions.md)]
