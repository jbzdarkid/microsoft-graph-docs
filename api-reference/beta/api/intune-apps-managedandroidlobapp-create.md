...
<!-- { "blockType": "permissions", "name": "intune_apps_managedandroidlobapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-managedandroidlobapp-create-permissions.md)]
