...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macosdevicefeaturesconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macosdevicefeaturesconfiguration-update-permissions.md)]
