...
<!-- { "blockType": "permissions", "name": "intune_partnerintegration_securityconfigurationtask_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-partnerintegration-securityconfigurationtask-create-permissions.md)]
