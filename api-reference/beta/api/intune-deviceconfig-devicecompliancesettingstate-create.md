...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecompliancesettingstate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecompliancesettingstate-create-permissions.md)]
