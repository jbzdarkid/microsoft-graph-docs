...
<!-- { "blockType": "permissions", "name": "intune_apps_enterprisecodesigningcertificate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-enterprisecodesigningcertificate-create-permissions.md)]
