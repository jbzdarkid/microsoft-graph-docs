...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depmacosenrollmentprofile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depmacosenrollmentprofile-update-permissions.md)]
