...
<!-- { "blockType": "permissions", "name": "intune_devices_devicelogcollectionresponse_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicelogcollectionresponse-get-permissions.md)]
