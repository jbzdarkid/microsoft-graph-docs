...
<!-- { "blockType": "permissions", "name": "intune_partnerintegration_securityconfigurationtask_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-partnerintegration-securityconfigurationtask-update-permissions.md)]
