...
<!-- { "blockType": "permissions", "name": "intune_devices_devicecompliancescriptdevicestate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicecompliancescriptdevicestate-create-permissions.md)]
