...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_iosikev2vpnconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-iosikev2vpnconfiguration-create-permissions.md)]
