...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depmacosenrollmentprofile_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depmacosenrollmentprofile-get-permissions.md)]
