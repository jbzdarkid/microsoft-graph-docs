...
<!-- { "blockType": "permissions", "name": "intune_devices_remoteactionaudit_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-remoteactionaudit-create-permissions.md)]
