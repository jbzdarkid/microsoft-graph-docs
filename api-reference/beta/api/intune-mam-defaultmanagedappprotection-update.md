...
<!-- { "blockType": "permissions", "name": "intune_mam_defaultmanagedappprotection_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-defaultmanagedappprotection-update-permissions.md)]
