...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidforworkvpnconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidforworkvpnconfiguration-create-permissions.md)]
...
## Response
If successful, this method returns a `201 Created` response code and a [androidForWorkVpnConfiguration](../resources/intune-deviceconfig-androidforworkvpnconfiguration.md) object in the response body.
