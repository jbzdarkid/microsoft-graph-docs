...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depmacosenrollmentprofile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depmacosenrollmentprofile-create-permissions.md)]
