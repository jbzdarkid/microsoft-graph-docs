...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macosdevicefeaturesconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macosdevicefeaturesconfiguration-create-permissions.md)]
