...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicypresentationvaluelist_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicypresentationvaluelist-create-permissions.md)]
