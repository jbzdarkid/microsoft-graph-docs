...
<!-- { "blockType": "permissions", "name": "fido2authenticationmethodconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/fido2authenticationmethodconfiguration-get-permissions.md)]
