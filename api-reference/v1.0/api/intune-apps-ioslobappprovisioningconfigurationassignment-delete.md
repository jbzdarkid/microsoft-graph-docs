...
<!-- { "blockType": "permissions", "name": "intune_apps_ioslobappprovisioningconfigurationassignment_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-ioslobappprovisioningconfigurationassignment-delete-permissions.md)]
