...
<!-- { "blockType": "permissions", "name": "intune_apps_enterprisecodesigningcertificate_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-enterprisecodesigningcertificate-delete-permissions.md)]
