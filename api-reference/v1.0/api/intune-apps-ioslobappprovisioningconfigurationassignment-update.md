...
<!-- { "blockType": "permissions", "name": "intune_apps_ioslobappprovisioningconfigurationassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-ioslobappprovisioningconfigurationassignment-update-permissions.md)]
