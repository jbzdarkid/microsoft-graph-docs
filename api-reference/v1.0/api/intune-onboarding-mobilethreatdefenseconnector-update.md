...
<!-- { "blockType": "permissions", "name": "intune_onboarding_mobilethreatdefenseconnector_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-mobilethreatdefenseconnector-update-permissions.md)]
