...
<!-- { "blockType": "permissions", "name": "intune_onboarding_mobilethreatdefenseconnector_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-mobilethreatdefenseconnector-create-permissions.md)]
